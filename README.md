...
- **Example 1**: 🎵 [Listen to example_1.wav](./asserts/example_1.wav)
  <details>
  <summary>🎧 Click to play audio (if supported)</summary>
  <audio src="./asserts/example_1.wav" controls preload="none" style="width: 100%; max-width: 400px;">
...
- **Example 2**: 🎵 [Listen to example_2.wav](./asserts/example_2.wav)
  <details>
  <summary>🎧 Click to play audio (if supported)</summary>
  <audio src="./asserts/example_2.wav" controls preload="none" style="width: 100%; max-width: 400px;">
    Your browser does not support the audio element.
  </audio>
  </details>
...
- **Example 3**: 🎵 [Listen to example_3.wav](./asserts/example_3.wav)
  <details>
  <summary>🎧 Click to play audio (if supported)</summary>
  <audio src="./asserts/example_3.wav" controls preload="none" style="width: 100%; max-width: 400px;">
    Your browser does not support the audio element.
  </audio>
  </details>
...
- **Example 4**: 🎵 [Listen to example_4.wav](./asserts/example_4.wav)
  <details>
  <summary>🎧 Click to play audio (if supported)</summary>
  <audio src="./asserts/example_4.wav" controls preload="none" style="width: 100%; max-width: 400px;">
    Your browser does not support the audio element.
  </audio>
  </details>
...
<details>
<summary>🎧 Click to play audio (if supported)</summary>
<audio src="./asserts/happy.wav" controls preload="none" style="width: 100%; max-width: 400px;">
  Your browser does not support the audio element.
</audio>
</details>
...
<details>
<summary>🎧 Click to play audio (if supported)</summary>
<audio src="./asserts/sarcastic.wav" controls preload="none" style="width: 100%; max-width: 400px;">
  Your browser does not support the audio element.
</audio>
</details>
