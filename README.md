...
[![arXiv](https://img.shields.io/badge/arXiv-Paper-b31b1b.svg)](https://arxiv.org/abs/YOUR_PAPER_ID) <!-- TODO: Replace with your actual arXiv ID -->
...
- **Example 1**: <audio controls><source src="./asserts/example_1.wav" type="audio/wav">Your browser does not support the audio element.</audio> [Download example_1.wav](./asserts/example_1.wav)
- **Example 2**: <audio controls><source src="./asserts/example_2.wav" type="audio/wav">Your browser does not support the audio element.</audio> [Download example_2.wav](./asserts/example_2.wav)
- **Example 3**: <audio controls><source src="./asserts/example_3.wav" type="audio/wav">Your browser does not support the audio element.</audio> [Download example_3.wav](./asserts/example_3.wav)
- **Example 4**: <audio controls><source src="./asserts/example_4.wav" type="audio/wav">Your browser does not support the audio element.</audio> [Download example_4.wav](./asserts/example_4.wav)
...
🎵 **Audio Output**: <audio controls><source src="./asserts/happy.wav" type="audio/wav">Your browser does not support the audio element.</audio> [Download happy.wav](./asserts/happy.wav)
...
🎵 **Audio Output**: <audio controls><source src="./asserts/sarcastic.wav" type="audio/wav">Your browser does not support the audio element.</audio> [Download sarcastic.wav](./asserts/sarcastic.wav)
